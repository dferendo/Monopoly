...
void GameMechanics::fillGroupColourSizeOfUpgradableProperties(map<Colour, int> &groupColoursSize) {
    groupColoursSize.insert(pair<Colour, int> (Black, 4));
    groupColoursSize.insert(pair<Colour, int> (White, 2));
    groupColoursSize.insert(pair<Colour, int> (Purple, 2));
    groupColoursSize.insert(pair<Colour, int> (Light_Blue, 3));
    groupColoursSize.insert(pair<Colour, int> (Violet, 3));
    groupColoursSize.insert(pair<Colour, int> (Orange, 3));
    groupColoursSize.insert(pair<Colour, int> (Red, 3));
    groupColoursSize.insert(pair<Colour, int> (Yellow, 3));
    groupColoursSize.insert(pair<Colour, int> (Dark_Green, 3));
    groupColoursSize.insert(pair<Colour, int> (Dark_Blue, 2));
}

UpgradableProperty* GameMechanics::createPurpleHouse(string houseName) {
    HousesPrice purpleHousePrice(50, 10, 30, 90, 160);
    return new UpgradableProperty(houseName, 60, 2, Purple, purpleHousePrice, 30);
}

GameBoard::RailRoad* GameMechanics::createRailRoad(string houseName) {
    return new RailRoad(houseName, 200, 25, Black, 100);
}

GameBoard::UpgradableProperty* GameMechanics::createLightBlueHouse(string houseName) {
...
GameBoard::UpgradableProperty* GameMechanics::createDarkGreenHouse(string houseName) {
...
GameBoard::UpgradableProperty* GameMechanics::createDarkBlueHouse(string houseName) {
